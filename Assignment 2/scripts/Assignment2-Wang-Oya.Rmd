...
Over time, the keyword `crime` had a mean search hit of 55.615 with a standard deviation of 9.282 and a variance of 86.163. The keyword `loans` had a mean search hit of 67.231 with a standard deviation of 9.924 and a variance of 98.495. While `loans` had a higher mean search frequency, there does not seem to be a large difference in the search frequency for interest over time. However, patterns can be seen in the plot. The two keywords may have an inverse relationship where search frequencies for `loans` tend to be high when `crime` is low, and vice versa. 
\
