...
```{r, message = FALSE, inclue=FALSE, echo = FALSE}
# Checking if including arrest = TRUE makes a difference. It does!
# SELECT count(arrest) AS arrest_count, arrest, primary_type
# FROM crime
# WHERE year = 2016 AND arrest = TRUE
...
# SELECT count(arrest) AS arrest_count, arrest, primary_type
# FROM crime
# WHERE year = 2016 AND arrest = FALSE
# GROUP BY arrest, primary_type
# ORDER BY arrest_count DESC
# LIMIT 10;
```
