...
```{r}
# Extract fifth table and name as pop3
pop3 <- tables[[5]]
pop3

# Clean up column names
colnames(pop3)[1] ="direction"
colnames(pop3)[2] ="communities"
pop3

# Take community names in row 9 (only community in the east) and save as character vector
east <- as.character(pop3[9,2])
east
```
...
east <- gsub("\n", ",_Chicago ", east) #add ,_Chicago to each community name
east
